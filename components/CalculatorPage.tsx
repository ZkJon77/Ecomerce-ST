...
import { Calculator, Plus, Minus, X, Check } from "lucide-react"
        ...
        {result && (
          <div style={{ background: "white", borderRadius: 14, padding: 16, boxShadow: "0 1px 8px rgba(0,0,0,0.06)", border: "2px solid #059669" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 14 }}>
              {[
                { label: "Área líquida", value: result.netArea + " m²", icon: "📐" },
                { label: "Total de tinta", value: result.totalLiters + " litros", icon: "🪣" },
